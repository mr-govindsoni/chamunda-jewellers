...
export default function NecklacesPage() {
  ...
  const products = [
    { 
      id: 1, 
      name: "Mayur Antique Gold Choker Set", 
      code: "CJ-NC-001", 
      categories: ["Antique Necklaces", "Choker Necklaces", "Daily Wear"],
      image: "/images/necklaces/necklace1.png",
      images: [
        "/images/necklaces/necklace1.png",
        "/images/necklaces/necklace2.png",
        "/images/necklaces/necklace3.png"
      ],
      desc: "An absolutely exquisite royal Rajasthani choker set featuring intricately carved peacock (Mayur) motifs, premium matte antique gold textures, and classic gold bead clusters. Lovingly handcrafted in our Charwas workshop to elevate your festive look.",
      specs: {
        "Metal Purity": "22K BIS Hallmarked Gold",
        "Artistry": "Rajasthani Antique Nakshi Work",
        "Includes": "Choker & Matching Earrings",
        "Weight Status": "Sourced via direct booking"
      }
    },
    { 
      id: 2, 
      name: "Royal Rajputana Pearl Choker Set", 
      code: "CJ-NC-002", 
      categories: ["Choker Necklaces", "Bridal Necklaces"],
      image: "/images/necklaces/necklace2.png",
      images: [
        "/images/necklaces/necklace2.png",
        "/images/necklaces/necklace1.png",
        "/images/necklaces/necklace4.png"
      ],
      desc: "An ultra-luxury choker necklace showcasing delicate kundan structures, hand-picked royal pearls, and dynamic drops of emerald green. Designed for grand Indian celebrations.",
      specs: {
        "Metal Purity": "18K/22K Hallmarked Gold Setting",
        "Embellishments": "Natural Kundan & Emerald Drops",
        "Artisan Guild": "Jaipur Kundan Core",
        "Weight Status": "Bespoke customized sizing available"
      }
    },
    { 
      id: 3, 
      name: "Vaikuntha Temple Gold Haran Set", 
      code: "CJ-NC-003", 
      categories: ["Temple Necklaces", "Long Necklaces", "Antique Necklaces"],
      image: "/images/necklaces/necklace3.png",
      images: [
        "/images/necklaces/necklace3.png",
        "/images/necklaces/necklace5.png",
        "/images/necklaces/necklace1.png"
      ],
      desc: "Imbued with divine aesthetic, this long gold necklace displays detailed carvings of sacred deities framed in temple arches, finished with a classic matte red gemstone lining.",
      specs: {
        "Metal Purity": "22K Hallmarked pure gold base",
        "Gems": "Premium natural Rubies",
        "Length": "Long elegant Haran styling",
        "Origin": "South Temple Craft Guild"
      }
    },
    { 
      id: 4, 
      name: "Modern Elegance Diamond Necklace", 
      code: "CJ-NC-004", 
      categories: ["Modern Necklaces", "Daily Wear"],
      image: "/images/necklaces/necklace4.png",
      images: [
        "/images/necklaces/necklace4.png",
        "/images/necklaces/necklace2.png",
        "/images/necklaces/necklace5.png"
      ],
      desc: "A breathtaking statement of contemporary elegance. This rose gold necklace set is lavishly encrusted with brilliant-cut round diamonds and a stunning solitaire drop.",
      specs: {
        "Metal Base": "18K High-Grade Rose Gold",
        "Diamonds": "VVS clarity round diamonds",
        "Certificate": "IGI Diamond Certification Status",
        "Aesthetic": "Modern minimalistic elite brand look"
      }
    },
    { 
      id: 5, 
      name: "Traditional Bridal Heavy Gold Set", 
      code: "CJ-NC-005", 
      categories: ["Bridal Necklaces", "Long Necklaces", "Temple Necklaces"],
      image: "/images/necklaces/necklace5.png",
      images: [
        "/images/necklaces/necklace5.png",
        "/images/necklaces/necklace3.png",
        "/images/necklaces/necklace4.png"
      ],
      desc: "The pinnacle of our bridal trousseau collection. A heavy necklace set boasting delicate traditional floral engravings, multi-layered gold beads, and matching hanging jhumkas.",
      specs: {
        "Metal Purity": "22K BIS 916 Hallmarked Gold",
        "Artistry Type": "Exquisite Bridal Filigree & Matte",
        "Weight": "Ideal bridal luxurious weight",
        "Lifetime Promise": "100% Exchangeable at Charwas Store"
      }
    }
  ];
  ...
  const handleWhatsAppEnquiry = (e, product) => {
    ...
    const message = `Hello Chamunda Jewellers, I want enquiry about this necklace design.\n\nProduct Name: ${product.name}\nProduct Code: ${product.code}\nImage Link: ${window.location.origin}${product.image}`;
  ...
  const handleShare = (e, product) => {
    e.stopPropagation();
    const shareUrl = `${window.location.origin}/collection/necklaces?id=${product.id}`;
    if (navigator.share) {
      navigator.share({
        title: product.name,
      ...
      <section className="relative py-24 md:py-32 bg-[#1f163b] overflow-hidden text-center">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 relative z-10 space-y-6">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 bg-white/5 border border-[#eebf63]/30 rounded-full">
            ...
            <span className="text-[10px] tracking-[0.25em] font-bold text-[#eebf63] uppercase">Royal Signature Couture</span>
          </div>
          ...
          <p className="text-gray-300 font-light text-sm sm:text-base tracking-wide max-w-xl mx-auto leading-relaxed">
            ...
            Experience pure luxury, timeless purity, and masterfully detailed gold craftsmanship.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-16 pb-32">
        {filteredProducts.length === 0 ? (
          <div className="text-center py-20 bg-white rounded-3xl border border-gray-100 p-8 shadow-sm">
            <p className="text-gray-400 font-light tracking-widest text-sm uppercase">No Necklaces Found in This Category</p>
          </div>
        ) : (
