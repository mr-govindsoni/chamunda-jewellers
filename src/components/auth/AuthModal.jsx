...
export default function AuthModal() {
  ...
  const [view, setView] = useState('login'); // login, signup, forgot, otp, success
                ...
                >
                  ...
                  <div className="mt-6 text-center space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <button type="button" onClick={() => handleSuccess()} className="py-2.5 rounded-lg border border-white/10 bg-white/5 hover:bg-white/10 text-white text-xs font-medium transition-colors flex justify-center items-center gap-2">
                ...
                >
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input type="text" required value={name} onChange={e => setName(e.target.value)} className="w-full bg-white/5 border border-white/10 rounded-xl py-3.5 pl-11 pr-4 text-white text-sm focus:outline-none focus:border-[#d4a54c] transition-colors" placeholder="Enter your full name" />
                    </div>
                  </div>
                  <div>
                    <label className="block text-[10px] text-gray-400 uppercase tracking-widest mb-1.5 ml-1">Email</label>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-500" />
                      <input type="password" required value={password} onChange={e => setPassword(e.target.value)} className="w-full bg-white/5 border border-white/10 rounded-xl py-3.5 pl-11 pr-4 text-white text-sm focus:outline-none focus:border-[#d4a54c] transition-colors" placeholder="Create a password" />
                    </div>
                  </div>
